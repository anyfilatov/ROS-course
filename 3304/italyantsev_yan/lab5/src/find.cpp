...
int main(int argc, char** argv)
{
    ...
    spawnRobot(node, robot.getName(), "/home/bedrang/.gazebo/models/beer/model.sdf", robot.getX(), robot.getY(), 0.0);
    spawnRobot(node, "exit_point", "/home/bedrang/.gazebo/models/dumpster/model.sdf", exitX, exitY, 0.0);
