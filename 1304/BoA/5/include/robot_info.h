...
public:
    ...
    RobotInfo(const std::string& name, double distancePrecision, double angularPrecision, double currentAngle, double linearSpeed, double angularSpeed, double maxLinearSpeed);
