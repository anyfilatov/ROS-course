...
void generateWorldFile(const std::string& dir, const std::string& name, const std::string& image, float robotX, float robotY, float goalX, float goalY) {
...
int main(int argc, char **argv) {
    ...
    std::string bashCommand = std::string("gnome-terminal --window -e \"/bin/bash -c \'cd $catkin_workspace;") + " roslaunch ros_lab4 " + worldName + "_map.launch; rosrun exec /bin/bash -i\'\"";
