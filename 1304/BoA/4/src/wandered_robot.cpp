...
int WanderedRobot::getDirection() {
    ...
    if (std::abs(m_goalX - m_fixedX) < m_epsilon) {
        ...
        if (((m_goalY - m_fixedY >= 0) && (m_goalY - m_y >= 0)) || ((m_goalY - m_fixedY < 0) && (m_goalY - m_y < 0))) {
            return 1;
        }
        return 0;
    }
        ...
        if (std::abs(y - m_y) < m_epsilon) {
            if (((m_goalX - m_fixedX >= 0) && (m_goalX - m_x >= 0)) || ((m_goalX - m_fixedX < 0) && (m_goalX - m_x < 0))) {
                return 1;
            }
            return 0;
        }
